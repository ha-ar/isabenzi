package com.example.isebenzi.loopj.android.image;
...
/**
 * Created by Silico Studio on 4/12/2016.
 */

//PorterShapeImageView
public class RoundCornorSmartImageView extends ImageView {
    ...
    public RoundCornorSmartImageView(Context context) {
        super(context);
    }

    public RoundCornorSmartImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundCornorSmartImageView(Context context, AttributeSet attrs, int defStyle) {
